                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="600" id="template_header" style='background-color: #0cbfc9; color: #ffffff; border-bottom: 0; font-weight: bold; line-height: 100%; vertical-align: middle; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; border-radius: 3px 3px 0 0;'>
                    <tr>
                      <td id="header_wrapper" style="padding: 36px 48px; display: block;">
                        <h1 style='font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 30px; font-weight: 300; line-height: 150%; margin: 0; text-align: left; text-shadow: 0 1px 0 #fff; color: #ffffff;'>Verify Your Email Address</h1>
                      </td>
                    </tr>
                  </table>
                  <!-- End Header -->
                          ...
                          <tr>
                            <td valign="top" style="padding: 48px 48px 0;">
                              <div id="body_content_inner" style='color: #303030; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 14px; line-height: 150%; text-align: left;'>
                                <p style="margin: 0 0 16px;">Hello, Welcome to your EDRUPTZ journey!</p>
                                <p style="margin: 0 0 16px;">Please verify your email address to continue further with Edruptz.</p>
                                <p style="margin: 0 0 16px;"> Click the link below to proceed with verification.</p>
                                <p>{{route('verification-student', $token)}}</p>
                                <p>&nbsp; <br />
                                </p>
                                <p>Thank You.</p>
                                <p>&nbsp; <br />
                          ...
                          <tr>
                            <td colspan="2" valign="middle" id="credit" style='border-radius: 6px; border: 0; color: #303030; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 12px; line-height: 125%; text-align: center; padding: 0 48px 48px 48px;'>
                              <p style="text-align:center ">
                                <img src="{{ asset('assets/images/edruptz.svg') }}" style="width:100px">
                              </p>
                            </td>
                          </tr>
                        </table>
