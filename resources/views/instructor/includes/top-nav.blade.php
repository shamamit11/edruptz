      ...
      <ul class="navbar-nav right-nav align-items-center float-end">
        <li class="nav-item dropdown profile-nav-item">
          ...
          <div class="menu-profile"> 
            ...
            @if($user->image)
            <img src="{{asset('/storage/uploads/instructor/'.$user->image)}}" class="rounded-circle">
            @else
          ...
          <div class="dropdown-menu">
            <div class="dropdown-body">
              <ul class="profile-nav p-0 pt-3">
                <li class="nav-item"> <a href="{{ route('instructor-account-setting') }}" class="nav-link"> <i class='bx bx-cog'></i> <span>Account Settings</span> </a> </li>
              </ul>
            </div>
            <div class="dropdown-footer">
              <ul class="profile-nav">
                <li class="nav-item"> <a href="{{ route('instructor-logout') }}" class="nav-link"> <i class='bx bx-log-out'></i> <span>Logout</span> </a> </li>
              </ul>
            </div>
          </div>
        </li>
