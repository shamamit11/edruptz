                                ...
                                <form action="{{ $profile_action }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="profession" type="text"
                                            value="{{ old('profession', isset($user->professional) ? $user->professional : '') }}"
                                            class="form-control">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="location" type="text"
                                            value="{{ old('location', isset($user->address) ? $user->address : '') }}"
                                            class="form-control">
                                        ...
                                        @if ($user && $user->image)
                                            <div id="image">
                                                <div style="margin:5px 0 0 0;"> <img
                                                        src="{{ asset('/storage/uploads/instructor/' . $user->image) }}"
