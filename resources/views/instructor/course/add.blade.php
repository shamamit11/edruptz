                ...
                <form enctype="multipart/form-data" method="post" action="{{ $action }}" id="form">
                    ...
                    @if ($row && count($row->skills) > 0)
                        ...
                        @foreach ($row->skills as $course_skill)
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">Percentage <small>Only Number - Eg: 40</small></label>
                                    <input type="number" class="form-control" name="percent_{{ $cnt }}"
                            ...
                            @for ($i = count($row->skills); $i < 3; $i++)
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <input type="number" class="form-control" name="percent_{{ $i + 1 }}"
                    ...
                    @else
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <label class="form-label">Percentage</label>
                                <input type="number" class="form-control" name="percent_1"
                                    value="{{ old('percent_1') }}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <label class="form-label">Percentage</label>
                                <input type="number" class="form-control" name="percent_2"
                                    value="{{ old('percent_2') }}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <label class="form-label">Percentage</label>
                                <input type="number" class="form-control" name="percent_3"
                                    value="{{ old('percent_3') }}">
