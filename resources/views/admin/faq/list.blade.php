    ...
    <div class="card mb-10">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <nav class="navbar navbar-light">
                ...
                <a href="{{ route('admin-faq-add') }}" class="btn btn-primary my-2 my-sm-0 ms-1"> Add</a>
            </nav>
        </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr id="tr{{ $row->id }}">
                        ...
                        <td style="text-align:center"><a href="{{route('admin-faq-add', ['id='.$row->id])}}"
