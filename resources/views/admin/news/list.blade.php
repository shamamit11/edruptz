    ...
    <div class="card mb-10">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <nav class="navbar navbar-light">
                ...
                <a href="{{ route('admin-blog-add') }}" class="btn btn-primary my-2 my-sm-0 ms-1"> Add</a>
            </nav> 
        </div>
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th scope="col" width="150" style="text-align:center">Date</th>
            <th scope="col">Blog Title</th>
                ...
                <tbody>
                    ...
                    <tr id="tr{{ $row->id }}">
                        ...
                        <td style="text-align:center"><a href="{{route('admin-blog-add', ['id='.$row->id])}}"
