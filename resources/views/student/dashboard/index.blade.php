...
<div class="main-content d-flex flex-column"> @include('student.includes.top-nav') 
  ...
  <div class="breadcrumb-area d-flex justify-content-between align-items-center">
    <div class="d-flex align-items-center">
      ...
      <ol class="breadcrumb">
        <li class="item">Member Since: {{ date('d M Y', strtotime($user->created_at)) }}</li>
      </ol>
    </div>
  </div>
  @if($courses->count() > 0)
    ...
    <div class="row"> @foreach($courses as $course)
      ...
      <div class="col-lg-4 col-md-6">
        <div class="stats-card-box">
          ...
          <span class="sub-title">{{ $course->course->name}}</span>
          <h3>{{ $reading_percent }}% <span class="badge"><i class="bx bx-up-arrow-alt"></i> {{ $reading_percent }}%</span></h3>
          <div class="progress-list">
            <div class="bar-inner">
              <div class="bar progress-line" data-width="{{ $reading_percent }}" style="width: {{ $reading_percent }}%;"></div>
            </div>
            <p><a href="{{ route('student-course-detail', Crypt::encryptString($course->course->id))}}" class="btn btn-primary my-2 my-sm-0 ms-1">View Details</a></p>
          </div>
        </div>
      </div>
      @endforeach </div>
  ...
  <?php /*?><div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="stats-card-box">
                    <div class="icon-box"> <i class='bx bxs-component'></i> </div>
                    <span class="sub-title">Total Course</span>
                    <h3>{{ $courses->count() }}</h3>
                    <div class="progress-list">
                        <div class="bar-inner">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="stats-card-box">
                    ...
                    <span class="sub-title">Total Sales</span>
                    <h3>{{ $sales->count() }} </h3>
                    <div class="progress-list">
                        <div class="bar-inner">
                            <div class="bar progress-line" data-width="32.1"></div>
                        </div>
                        <p>Total sales made till date</p>
                    </div>
                </div>
            </div>
        </div><?php */?>
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu"> <a class="dropdown-item d-flex align-items-center" href="#">
                                    <i class='bx bx-show'></i> View </a> <a class="dropdown-item d-flex align-items-center"
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="dropdown">
                            <button class="dropdown-toggle" type="button" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false"> <i class='bx bx-dots-horizontal-rounded'></i>
                            </button>
                            <div class="dropdown-menu"> <a class="dropdown-item d-flex align-items-center"
                                    href="#"> <i class='bx bx-show'></i> View </a> <a
                                    class="dropdown-item d-flex align-items-center" href="#"> <i
                    ...
                    <div class="card-body widget-todo-list">
                        <ul>
                            <li>
                                ...
                                <div class="todo-item-action"> <a href="#" class="edit"><i
