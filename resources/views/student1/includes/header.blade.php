            ...
            <div class="widget-content-wrapper">
              ...
              <div class="widget-content-right header-user-info ml-3">
                <button type="button" class="p-1 btn profilePic"  data-toggle="dropdown">@if($user && $user->image)
                 ...
                 <img src="{{asset('/storage/uploads/student/'.$user->image)}}" />
                 @else
                <img src="{{asset('/assets/images/profile.svg')}}" alt="" /> @endif<span class="profileOn"></span></button>
                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                    <button type="button" tabindex="0" class="dropdown-item" onclick="window.location.href='{{ route('student-account-setting') }}'">Account Settings</button>
                    <div tabindex="-1" class="dropdown-divider"></div>
                    <button type="button" tabindex="0" class="dropdown-item" onClick="window.location='{{ route('student-logout') }}'">Log Out</button>
                  </div>
              </div>
            </div>
          </div>
