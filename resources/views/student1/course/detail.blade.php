    ...
    <div class="app-main__outer">
      <div class="app-main__inner">
        <ol class="nobg breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{ route('student-course') }}">Courses</a></li>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12"> @include('student.includes.alert')
              ...
              <div class="card mb-4">
                ...
                <div class="card-body"> @foreach($row->lessons as $lesson)
                  <div class="mb-2">{{ $cnt }}. <a href="{{ route('student-lesson', [$row->slug, Crypt::encryptString($lesson->id)]) }}">{{ $lesson->name }}</a> <span class="pull-right alert-info px-2"> @if($lesson->status == 1)Read @else Unread @endif</span></div>
                   @php $cnt++ @endphp
                  @endforeach </div>
              </div>
              @endif
			...
			@for($i = 1; $i<=$avg_rating; $i++)
             ...
             @endif <small class="pull-right  alert-info px-2"> {{ count($row->instructor->reviews) }} reviewed </small> </div>
              ...
              <div class="card mb-4">
                <div class="card-header"> Instructor Ratings </div>
                <div class="card-body">
